...
function checkHistory(){
	console.log(localStorage.getItem("setHistory"));
	if(localStorage.getItem("setHistory") == "true"){
		setHistory();
		localStorage.setItem("setHistory", false);
	}
}
var historyList = 0;
...
function setHistory(){
	var test = "";
	correctPlayers.forEach(function(players){
